...
os.system('rm sports.onbrs sportss.onbrs')
os.system('sort -n -k 1 -k 2 sports.nbrs >> sports.onbrs')
os.system('./sd_serial  -nnbrs=50 -minsim=.3 sports.mat sportss.nbrs')
os.system('sort -n -k 1 -k 2 sportss.nbrs >> sportss.onbrs')

os.system('rm zdiff.txt')
print 'diff sports.onbrs sportss.onbrs > zdiff.txt'
os.system('diff sports.onbrs sportss.onbrs > zdiff.txt')
os.system('head zdiff.txt')
